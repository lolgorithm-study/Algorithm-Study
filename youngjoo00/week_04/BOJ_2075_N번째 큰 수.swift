// BOJ_2075_N번째 큰 수.swift
// 우선순위 큐에 들어간 수들 중 N번째로 큰 수를 출력하시오
...
// 최대 힙 생성
var maxPriortyQueue = PriorityQueue<Int>(sort: >)

for _ in 0..<N*N {
    maxPriortyQueue.enqueue(element: file.readInt())
}

for _ in 0..<N-1 {
    maxPriortyQueue.dequeue()
}

print(maxPriortyQueue.peek()!)
